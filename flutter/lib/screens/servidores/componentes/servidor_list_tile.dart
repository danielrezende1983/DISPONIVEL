...
class ServidorListTile extends StatelessWidget {

  const ServidorListTile(this.servidor);
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<DocumentSnapshot>(
      future: FirebaseFirestore.instance.doc('users_vip_servidor/${servidor.userTitular}').get(),
        ...
        builder: (_, servidorManager, usuarioVipManager, __){
          ...
          return GestureDetector(
            onTap: (){
              ...
              servidorManager.servidorSelecionado = servidor;
              usuarioVipManager.usuarioVipSelecionado = usuarioVip;
              Navigator.of(context).pushNamed('/servidor');
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: mostrarListaImagensDecorationImage(servidor?.images, 'images/servico_006_512.png'),
                      ),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            truncar('${servidor.estado} - ${servidor.cidade}', 25),
                            style: TextStyle(
                                fontSize: 12,
  ...
  Text _usuarioTitular(){
    ...
    return Text(
      truncar(servidor.userTitular, 40),
      style: const TextStyle(
        fontSize: 10,
        fontWeight: FontWeight.w800,
      ),
